...
if(!process.env.GITHUB_API_PORT) console.log("required GITHUB_API_PORT enviroment variable is missing" );
if(!process.env.STATUS_API_PORT) console.log("required STATUS_API_PORT enviroment variable is missing" );
